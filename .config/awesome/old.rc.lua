...
beautiful.init("/home/alex/.config/awesome/themes/obscur/theme.lua")
...
tags = {
	...
	layout = { layouts[1], layouts[1], layouts[2], layouts[1], layouts[1], layouts[2]
}}
...
vicious.register(datewidget, vicious.widgets.date, "%l:%M %P ", 60)
